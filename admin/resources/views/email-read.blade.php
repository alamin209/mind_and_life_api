                    ...
                    <div class="card-body">
                        <div class="media mb-4">
                            <img class="d-flex mr-3 rounded-circle avatar-sm"
                                 src="{{ URL::asset('public/images/users/avatar-2.png') }}"
                        ...
                        <div class="row">
                            <div class="col-xl-2 col-6">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="/images/small/img-3.jpg"
                                         alt="Card image cap">
                            ...
                            <div class="col-xl-2 col-6">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="/images/small/img-4.jpg"
                                         alt="Card image cap">
                                    <div class="py-2 text-center">
                                        <a href="" class="font-weight-medium">Download</a>
                                    </div>
