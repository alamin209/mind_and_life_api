                        ...
                        <div class="col-lg-6">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <p class="card-title-desc">Use the <code>.badge-pill</code> modifier class to make
                                    badges more rounded (with a larger <code>border-radius</code> and additional
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <p class="card-title-desc">Pagination links are customizable for different
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mt-4">
                                ...
                                <p class="card-title-desc">Fancy larger or smaller pagination? Add
                                    <code>.pagination-lg</code> or <code>.pagination-sm</code> for additional sizes.
                                </p>
                        ...
                        <div class="col-lg-6">
                            <div class="mt-4">
                                ...
                                <p class="card-title-desc">Change the alignment of pagination components with flexbox
                                    utilities.</p>
