    ...
    <div class="row">
        ...
        <div class="col-md-12 col-lg-12 ">
            <div class="card">
                    ...
                    <form method="POST" action="{{ url('article/'.$article->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="form-control select2" required>
                                ...
                                @foreach($users as $user)
                                    <option @if($article->user_id == $user->id) selected="selected"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" value="{{ $article->title ?? '' }}"
                                   placeholder="Give Article Title" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="article_image[]" accept="image/*"  class="form-control" multiple="">
                            <img id="image_path"/>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Description </label>
                            <textarea name="description" id="project_details" rows="10"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="post_date" value="{{ $article->post_date ?? '' }}"
                                   type="date" placeholder="Give Article Date" required>
                        </div>
                            ...
                            @isset($article->article_tags)
                                @foreach ( $article->article_tags  as $article->article_tag )
                                    <div style="margin-bottom:10px">
                                        <input class="form-control {{ $article->index+1 }}" required
                                               placeholder="Give the tag name"
                                               value="{{$article->article_tag['tag_name']}}" type="text"
                                               name="tag_name[]"><a href="#"
                                                                    class="remove_field {{ $article->index+1 }}">Remove</a>
                                    </div>
                        </div>
                    @endforeach
                    @endisset
                ...
                <div class="form-group">
                    <button class="form-control btn btn-primary waves-effect waves-light" style="auto;width:20% ;color:black">
                        Submit
                    </button>
                </div>
