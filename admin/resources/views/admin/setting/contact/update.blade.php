        ...
        <div class="col-md-12 col-lg-12 ">
            ...
            <div class="card">
                ...
                <div class="card-body" style="overflow-y: auto;">
                    <form method="POST" action="{{ url('upadte-about-us/'.$aboutUs->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label class="control-label">title</label>
                            <input class="form-control" name="title" value= "{{ $aboutUs->title }}" type="text" placeholder="Give Article Title"
                                   required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                              ...
                              <img src="{{ url($aboutUs->image_path) }}" alt="{{ $aboutUs->title ?? "" }}" style="height:150px; width:150px">
                        </div>

                        <div class="form-group">
                            <label class="control-label">Description </label>
                            <textarea name="description" id="project_details" rows="10" class="form-control">{{ $aboutUs->description ?? '' }}</textarea>
                        </div>
