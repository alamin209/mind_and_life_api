...
@section('content')
    @component('common-components.breadcrumb')
        @slot('title') Update Coupon   @endslot
        @slot('li_1')   @endslot
        ...
        <div class="col-md-12 col-lg-12 ">
            ...
            <div class="card">
                ...
                <div class="card-body" style="overflow-y: auto;">
                    <form method="POST" action="{{ route('coupon/'.$coupon->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="form-group">
                            @if (file_exists($coupon->image_path))
                                Prevous Photo
                                <img src="{{ asset($coupon->image_path) }}" height="70px" width=70px
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" class="form-control select2" required>
                                ...
                                @foreach($categories as $category)
                                    <option @if($article->category_id == $category->id) selected="selected"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="heading" type="text" value="{{$coupon->heading}}"
                                   required>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Expire Date</label>
                            <input class="form-control" name="expire_date" value="{{$coupon->expire_date}}" type="date"
                                   required>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Offer Brand</label>
                            <input class="form-control" name="offer_brand" value="{{$coupon->offer_brand}}" type="text"
                                   required>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Price</label>
                            <input class="form-control" name="price" value="{{$coupon->price}}" type="number" required>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Download Limit</label>
                            <input class="form-control" name="download_limit" value="{{$coupon->download_limit}}"
                                   type="number" required>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Total Download</label>
                            <input class="form-control" name="total_download" value="{{$coupon->total_download}}"
                                   type="number" required>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Description </label>
                            <textarea name="description" id="project_details" rows="10" class="form-control">
                                {{$coupon->description ?? ''}}
                            </textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="term_condition" id="project_details" rows="5" class="form-control">
