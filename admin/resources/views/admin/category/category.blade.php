...
<div class="row" >
    ...
    <div class="col-md-12 col-lg-12 ">
        ...
        <div class="col-md-12 col-lg-12 ">
            ...
            <div class="card">
                <button type="button" class="btn btn-success waves-effect waves-light "style="height:10%;width:10%" data-toggle="modal" data-target="#addnewcategory">
...
<div id="addnewcategory"   class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
