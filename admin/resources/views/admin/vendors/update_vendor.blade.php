<form action="{{ url('vendors/' . $vendor->id) }}" method="Post" class="custom-validation"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="company_name" value="{{ $vendor->company_name }}" required
                                       class="form-control" placeholder="Give company name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="contact_name" value="{{  $vendor->contact_name }}"
                                       class="form-control" required="" placeholder="Give contact name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="post_title" name="post_title" class="form-control"
                                       value="{{  $vendor->post_title }}" required="" placeholder="Give post titles">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="company_email" value="{{  $vendor->company_email }}" required
                                       class="form-control" placeholder="Give company email ">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="company_phone" value="{{  $vendor->company_phone }}"
                                       class="form-control" placeholder="Give  company phone ">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <img id="company_signature_update"
                                     src="{{ url('public/company_signature/'. $vendor->company_signature)}}"
                                     alt="No Image Found" height="200px" width="200px"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <img id="company_seal_update"
                                     src="{{ url('public/company_seal/'. $vendor->company_seal) }}" alt="No image fund"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status" required>
                                ...
                                <option @if($vendor->status ==0) selected="selected" @endif  value="0">In-Active
                                </option>
                            </select>
                        </div>
