                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="user_id">
                                @foreach($user as $u )
                                    <option @if( $ipaddress->user_id == $u->id  ) required selected="selected"
                                            @endif  value="{{ $u->id }}"> {{ $u->username }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="ip_address" required value="{{ $ipaddress->ip_address }}"
