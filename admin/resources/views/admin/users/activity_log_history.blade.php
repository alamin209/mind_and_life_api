...
@section('content')
    ...
    @component('common-components.breadcrumb')
         @slot('title') User Acivity Log    @endslot
         @slot('li_1')   @endslot
     @endcomponent
                    ...
                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                        ...
                        <table id="tech-companies-1" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>SL</th>
                                    <th data-priority="1">Login name </th>
                                    <th data-priority="2">description</th>

                                    <th data-priority="3">Done By </th>
                                    <th data-priority="4">Details Acvity </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                     ...
                                     <td>
                                        {{-- @php  echo $activity_details = json_encode($activity->properties, true)  @endphp --}}
                                    ...
                                    <td>
                                        ...
                                        {{   date( "h:i:sa",strtotime ($activity->created_at) ) }}
                                    </td>
                                </tr>
...
<div id="addnewipaddress"   class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="card-body">
                                <form action="{{  route('userlist.store') }}"  method="Post" class="custom-validation">
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <div>
                                            <input type="text" name="name"  required  class="form-control" required=""  placeholder="user name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>User Email</label>
                                        <div>
                                            <input type="text" name="password"  required  class="form-control" value="admin12345" required=""  placeholder="bydefault it will ">
                                        </div>
                                    </div>
