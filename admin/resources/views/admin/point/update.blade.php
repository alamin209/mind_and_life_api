...
@section('content')
    @component('common-components.breadcrumb')
        @slot('title')Create New Point @endslot
        @slot('li_1') @endslot
        ...
        <div class="col-md-12 col-lg-12 ">
            ...
            <div class="card">
                ...
                <div class="card-body" style="overflow-y: auto;">
                    <form method="POST" action="{{ route('point.update', $point['id']) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="referral_point"
                                        value="{{ $point['referral_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="article_share__point"
                                        value="{{ $point['article_share__point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="article_like_point"
                                        value="{{ $point['article_like_point'] }}" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="article_bookmark_point"
                                        value="{{ $point['article_bookmark_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="article_read_point"
                                        value="{{ $point['article_read_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="share_video_point"
                                        value="{{ $point['share_video_point'] }}" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="video_like_point"
                                        value="{{ $point['video_like_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="video_bookmark_point"
                                        value="{{ $point['video_bookmark_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="video_watch_point"
                                        value="{{ $point['video_watch_point'] }}" type="text"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="share_coupon_point"
                                        value="{{ $point['share_coupon_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="download__coupon_point"
                                        value="{{ $point['download__coupon_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="redeem_coupon_point"
                                        value="{{ $point['redeem_coupon_point'] }}" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="share_quiz_point"
                                        value="{{ $point['share_quiz_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="doing_quiz_point"
                                        value="{{ $point['doing_quiz_point'] }}" type="text"
                            ...
                            <div class="col-md-4 col-lg-4 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="quiz_point" value="{{ $point['quiz_point'] }}"
                                        type="text" placeholder="Give quiz point">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-7 col-lg-7 ">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="daily_login_point"
                                        value="{{ $point['daily_login_point'] }}" type="text"
