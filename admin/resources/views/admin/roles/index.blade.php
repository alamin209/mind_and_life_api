...
@section('content')
                    ...
                    <div class="table-rep-plugin mt-2">
                        ...
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            ...
                            <button type="button" class="btn btn-success waves-effect waves-light "
                                    style=" margin-top:10px !important" data-toggle="modal" data-target="#addnewrole">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" onclick="selectid2({{ $role->id }} )"
                                                    ...
                                                    style="margin-right:20px" onclick="selectid2({{  $role->id }} )"
                                                    data-toggle="modal" data-target="#updatenewrole">
    ...
    <div id="addnewrole" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
    ...
    <div id="updatenewrole" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div id="txtHint">
