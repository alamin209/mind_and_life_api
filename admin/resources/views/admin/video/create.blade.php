...
@component('common-components.breadcrumb')
         @slot('title')Create New Video   @endslot
         @slot('li_1')   @endslot
                ...
                <div class="card-body"   style="overflow-y: auto;"  >
                    <form method="POST" action="{{ route('videos.store') }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="title" type="text" placeholder="Give Article Title" required>
                        </div>

                        <div class="custom-control custom-checkbox" style="margin-bottom:15px">
                            <input type="checkbox" name= 'check_type' class="custom-control-input" value="1" id="invalidCheck">
                        ...
                        <div class="form-group autoUpdate" id="autoUpdate" style="display:none;">
                            ...
                            <div>
                                <input type="text" name="youtube_link" class="form-control"
                                    placeholder="Please  Youtube Link">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="project_details" id="project_details" rows="10" class="form-control"></textarea>
                        </div>


                        <div class="form-group">
                            <label class="control-label">Posting Date</label>
                            <input class="form-control" name="post_date" type="date" placeholder="Give Article Date" required>
                        </div>
                        ...
                        <div class="input_fields_wrap" style="margin-bottom:10px" >
                            ...
                            <div  style="margin-bottom:10px">
                                <input  class="form-control" required  placeholder="Give the tag name" type="text" name="tag_name[]">
                            </div>
                        </div>
