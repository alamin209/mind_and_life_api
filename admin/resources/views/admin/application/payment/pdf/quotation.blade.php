...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <table width="100%">
                <tr>
                    <td style="text-align: right" width="50%"><img
                            ...
                            src="{{ public_path('system/logo/logo.png')}}"></td>

                    <td style="text-align: right">
                        <strong> <a
                                href="mailto:{{ $application->vendor->company_email }}">{{ $application->vendor->company_email }}</a>
                            | <a href="http://www.thenextbigthinghk.com/">www.thenextbigthinghk.com</a></strong>
                        <br/>
            ...
            <h4 style="font-size:20px"> 5.一旦確認設計，生產週期應在收到所有由客戶提供的網頁資料後 20-60 個工作日內完成（不包括 UAT）。 關於設 計和制作，
                客戶均需予以意見及協助，我們會給客戶最多 10 天，每個部分完成 UAT，任何額外的天數將有機會
            ...
            <h4 style="font-size:20px">6. 客戶應 UAT 提及所有必要的更改。 UAT 的時間為 10 天，不包括於開發時間內。如果客戶未能提及 UAT 所有 必要的更改， The Next Big
                Thing Limited 有權暫停或終止該項目開發。此外，額外收費將以 HK1,000/日作基
            </h4>
            ...
            <h4 style="font-size:20px"> 9． 如果客戶在開發過程中或 UAT 期間終止項目， The Next Big Thing Limited 有權不退還任何已付之費用，並保
                留採取追究法律責任的權利。</h4>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="text-align: right">
                        <strong> <a href="mailto:info@thenextbigthinghk.com">info@thenextbigthinghk.com</a> | <a
