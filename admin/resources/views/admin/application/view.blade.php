                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <button class="btn btn-success"><a
                                    href="{{ route('application-invoices.index',$application->id) }}">Invoice</a>
                            </button>
                            <button class="btn btn-success"><a
                                    href="{{ route('application-payments.index',$application->id) }}">Payment</a>
                            </button>
                            ...
                            <button class="btn btn-success" onclick="getprint('printarea')">Completion
                                Letter</a></button>
                        ...
                        <div id="printarea">
                            ...
                            <div class="col-sm-12">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            <strong> <a
                                                    href="mailto:{{ $application->vendor->company_email }}">{{ $application->vendor->company_email }}</a>
                                                | <a
                                                    href="http://www.thenextbigthinghk.com/">www.thenextbigthinghk.com</a></strong>
                                            <br/>
                                            {{ $application->vendor->company_phone }}
                                            <span
                                                style="text-align: right">{{ $application->vendor->company_phone }}</span><br/>
                                            <span
                                                style="text-align: right">{{ $application->vendor->company_address }}</span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" class="table-bordered" style="border:2px solid black !important">
                                    <tr style="border:2px solid black !important">
                                        <td width="65%" style="border:2px solid black !important" class="textpadding">
                                            <h4 style="font-weight:bold;padding: 4px;" class="textpadding">Company
                                                Name: {{ $application->project->client->name_en }}</h4>
                                        </td>
                                        <td style="border:2px solid black !important" width="35%">
                                            <h4 style="font-weight:bold;padding: 4px;"> Date
                                                : {{ date('d-m-Y', strtotime( $application->created_at )) }} </h4>
                                    ...
                                    <tr style="border:2px solid black !important">
                                        <td width="65%" style="border:2px solid black !important;padding: 4px;">
                                            <h4 style="font-weight:bold;padding: 4px;"> Contact
                                                Person: {{ $application->project->client->contact_person }} </h4>
                                        </td>
                                    ...
                                    <tr style="border:2px solid black !important">
                                        <td width="65%" style="border:2px solid black !important">
                                            <h4 style="font-weight:bold;padding: 4px;">Contact no
                                                : {{ $application->project->client->contact_number }} </h4>
                                        </td>
                                        <td style="border:2px solid black !important" width="35%">
                                            <h4 style="font-weight:bold ;padding: 4px; "> Quotation
                                                No. {{ $application->quotation_no }}</h4>

                                        </td>
                                    </tr>
                                    <tr style="border:2px solid black !important ;padding: 4px; ">
                                        <td width="65%" style="border:2px solid black !important ; padding: 4px;">
                                            <h4 style="font-weight:bold ;padding: 4px; ">Company
                                                Address: {{ $application->project->client->address }} </h4>
                                        </td>
                                        <td style="border:2px solid black !important" width="35%">
                                ...
                                <h2 style="text-align: center;padding: 4px; border:2px solid black !important ">
                                    ==詳細內容==</h2>
                                ...
                                <h4 style="font-size:20px">
                                    1．款項將從客戶簽訂本報價後收取，分兩次收取，首次為項目總額30%。最後尾期（即項目給予客戶測試後）付款為總額70％，於項目完成後3個月內支付 。</h4>
                                <h4 style="font-size:20px"> 2． 付款應通過支票（抬頭為“The Next Big Thing Limited” ）或銀行轉賬到富邦銀行帳號：
                                    8530-7049-779。</h4>
                                <h4 style="font-size:20px"> 3.所有的收費以港幣結算</h4>
                                <h4 style="font-size:20px"> 4.如照片、影片和文字信息應由客戶提供，並由客戶擁有版權。</h4>
                                <h4 style="font-size:20px"> 5.一旦確認設計，生產週期應在收到所有由客戶提供的網頁資料後 20-60 個工作日內完成（不包括 UAT）。 關於設
                                    計和制作， 客戶均需予以意見及協助，我們會給客戶最多 10 天，每個部分完成 UAT，任何額外的天數將有機會
                                ...
                                <h4 style="font-size:20px">6. 客戶應 UAT 提及所有必要的更改。 UAT 的時間為 10 天，不包括於開發時間內。如果客戶未能提及 UAT 所有
                                    必要的更改， The Next Big Thing Limited 有權暫停或終止該項目開發。此外，額外收費將以 HK1,000/日作基
                                </h4>
                                ...
                                <h4 style="font-size:20px"> 9． 如果客戶在開發過程中或 UAT 期間終止項目， The Next Big Thing Limited
                                    有權不退還任何已付之費用，並保 留採取追究法律責任的權利。</h4>
                                ...
                                <h4 style="font-size:20px"> 13． 維護不包括黑客 DDOS 或任何惡意攻擊。維護將僅包括編程問題，或因我方出錯、
                                    瀏覽器升級等引起的問題。</h4>
                                <table width="100%">
                                    <tr>
                                        <td style="text-align: right" width="50%"><img
                                        ...
                                        <td style="text-align: right">
                                            <strong> <a href="mailto:info@thenextbigthinghk.com">info@thenextbigthinghk.com</a>
                                                | <a
                                                    href="http://www.thenextbigthinghk.com/">www.thenextbigthinghk.com</a></strong>
                                            <br/>+852 2156 9906
