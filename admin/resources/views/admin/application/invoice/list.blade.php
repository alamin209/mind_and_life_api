...
<div class="row">
    ...
    <div class="col-md-12 col-lg-12 ">
        ...
        <div class="col-md-12 col-lg-12 ">
            <div class="card">
                <button type="button" class="btn btn-success waves-effect waves-light "style="height:10%;width:10%" data-toggle="modal" data-target="#addInvoice">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group mr-1 mt-2">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"   href="{{ route('application-invoices.showInvoice', $invoce->id) }}">PDF</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a  class="dropdown-item" href="{{ route('application-invoices.edit', $invoce->id) }}">Edit</a>
                                                        <div class="dropdown-divider"></div>

                                                        <a  class="dropdown-item" href="{{ route('application-invoices.edit', $invoce->id) }}">Payment</a>
                                                        <div class="dropdown-divider"></div>

                                                        <a  class="dropdown-item" href="{{ route('application-invoices.edit', $invoce->id) }}">View Invoice</a>
                                                        <div class="dropdown-divider"></div>
                                                    </div>
                                                </div>
...
<div id="addInvoice"   class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12 col-lg-12">
                       <div class="card">
                            <div class="card-body">
                                <form action="{{  route('application-invoices.store') }}"  method="Post" class="custom-validation">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <input type="hidden"  name="application_id"  value="{{ $application->id }}"   required  class="form-control" >
                                        </div>
                                    ...
                                    <span style=" font-size:20px; color:red" > Total Amount:  {{$application->sub_total }}</span>
                                    <div class="form-group">
                                        <label>Amount</label>
                                        <div>
                                            <input type="number" step="any"  disabled id="amount2"  readonly  value="{{ $application->sub_total }}"   required  class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <label for="switch3"  id="switchText" style="background-color: #45cb85;" data-on-label="Yes" data-off-label="No"></label>
                                        </div>

                                        <div style="display:none" id="client_other">
                                            <input type="text"    name="attention_name"  value=""   placeholder="Give attention  name"    class="form-control" >
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea    class="form-control"  name="description"  id="description" rows="150"  cols="150" > @if(old('description')) {{ old('description') }} @else {!! $detailsTemplate !!}  @endif </textarea>
                                        </div>
                                    </div>
                              </div>
                          </div>
