        ...
        <div class="col-md-12 col-lg-12 ">
            <div class="card">
                <button type="button" class="btn btn-success waves-effect waves-light " style="height:10%;width:10%"
                    ...
                    <a style="text-decoration: none; color: #FFF" href="{{ route('applications.create') }}"><i
                            class="bx bx-fa-plus font-size-16 align-right"> Add new </i></a>
                    ...
                    <table class="table client-dt">
                        ...
                        @foreach ($applications as $application)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success"><a style="color: #FFF; text-decoration: none"
                                                                       href="{{ route('applications.show', $application->id) }}">View</a>
                                    </button>
                                    <button class="btn btn-warning"><a style="color: #FFF; text-decoration: none"
                                                                       href="{{ route('applications.edit', $application->id) }}">Edit</a>
                                    </button>
                                </td>
                            </tr>
                        @endforeach
