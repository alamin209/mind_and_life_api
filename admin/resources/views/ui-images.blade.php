        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="rounded mr-2" alt="200x200" width="200" src="/images/small/img-4.jpg"
                                 data-holder-rendered="true">
                        </div>
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="rounded-circle avatar-xl" alt="200x200"
                                     src="{{ URL::asset('public/images/users/avatar-4.png') }}"
                                     data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="img-thumbnail" alt="200x200" width="200" src="/images/small/img-3.jpg"
                                 data-holder-rendered="true">
                        </div>
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200"
                                     src="{{ URL::asset('public/images/users/avatar-3.png') }}"
                                     data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Images in Bootstrap are made responsive with <code
                            ...
                            100%;</code> and <code class="highlighter-rouge">height: auto;</code> are applied to the
                        image so that it scales with the parent element.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div>
                                        <img src="{{ URL::asset('public/images/users/avatar-3.png') }}" alt=""
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <img src="{{ URL::asset('public/images/users/avatar-4.png') }}" alt=""
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <img src="{{ URL::asset('public/images/users/avatar-5.png') }}" alt=""
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">The default media displays a media object (images, video, audio) to the
                        left or right of a content block.
                    </p>

                    <div class="media mb-4">
                        <img class="d-flex mr-3 rounded-circle"
                             src="{{ URL::asset('public/images/users/avatar-6.png') }}" alt="Generic placeholder image"
                             height="64">
                        <div class="media-body">
                            <h5 class="mt-0 font-size-16">Media heading</h5> Cras sit amet nibh libero, in gravida
                    ...
                    <div class="media mb-4">
                        <img class="d-flex mr-3 rounded-circle"
                             src="{{ URL::asset('public/images/users/avatar-2.png') }}" alt="Generic placeholder image"
                             height="64">
                        <div class="media-body">
                            <h5 class="mt-0 font-size-16">Media heading</h5> Cras sit amet nibh libero, in gravida
                            nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in
                            ...
                            <div class="media mt-3">
                                <a class="d-flex pr-3" href="#">
                                    <img src="{{ URL::asset('public/images/users/avatar-3.png') }}"
                                         alt="Generic placeholder image" height="64" class="rounded-circle">
                                </a>
                                <div class="media-body">
                                    <h5 class="mt-0 font-size-16">Media heading</h5> Cras sit amet nibh libero, in
                    ...
                    <div class="media">
                        <div class="media-body">
                            <h5 class="mt-0 mb-1 font-size-16">Media object</h5> Cras sit amet nibh libero, in gravida
                            nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in
                            vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla.
                            Donec lacinia congue felis in faucibus.
                        </div>
                        <img class="d-flex ml-3 rounded-circle"
                             src="{{ URL::asset('public/images/users/avatar-4.png') }}" alt="Generic placeholder image"
                             height="64">
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">The images or other media can be aligned top, middle, or bottom. The
                        default is top aligned.</p>

                    <div class="media mb-4">
                        <img class="d-flex align-self-start rounded mr-3"
                             src="{{ URL::asset('public/images/users/avatar-3.png') }}" alt="Generic placeholder image"
                             height="64">
                        <div class="media-body">
                    ...
                    <div class="media mb-4">
                        <img class="d-flex align-self-center rounded mr-3"
                             src="{{ URL::asset('public/images/users/avatar-5.png') }}" alt="Generic placeholder image"
                             height="64">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img class="d-flex align-self-end rounded mr-3"
                             src="{{ URL::asset('public/images/users/avatar-1.png') }}" alt="Generic placeholder image"
                             height="64">
                        <div class="media-body">
