                    ...
                    <div class="tab-content p-3 text-muted">
                        ...
                        <div class="tab-pane" id="messages" role="tabpanel">
                            <p class="mb-0">
                                ...
                                pitchfork. Williamsburg banh mi whatever gluten yr.
                            </p>
                        </div>
                    ...
                    <div class="tab-content p-3 text-muted">
                        ...
                        <div class="tab-pane" id="settings-1" role="tabpanel">
                            <p class="mb-0">
                                ...
                                out master cleanse gluten-free squid scenester freegan cosby sweater. Fanny pack
                                portland seitan DIY, art party locavore wolf cliche high life echo park Austin. Cred
                                vinyl keffiyeh DIY salvia PBR, banh mi before they sold out farm-to-table.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                    ...
                                    <p class="mb-0">DIY synth PBR banksy irony. Leggings gentrify squid 8-bit cred
                                        pitchfork. Williamsburg banh mi whatever gluten-free.</p>
                                </div>
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                    ...
                                    <p class="mb-0">Fanny pack portland seitan DIY, art party locavore wolf cliche high
                                        life echo park Austin. Cred vinyl keffiyeh DIY salvia PBR, banh mi before they
                    ...
                    <div class="tab-content p-3 text-muted">
                        ...
                        <div class="tab-pane" id="settings1" role="tabpanel">
                            <p class="mb-0">
                                ...
                                locavore cosby sweater. Lomo wolf viral, mustache readymade keffiyeh craft.
                            </p>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc mb-3">
                        You can use a link with the <code class="highlighter-rouge">href</code> attribute, or a button
                        with the <code class="highlighter-rouge">data-target</code> attribute. In both cases, the <code
                            class="highlighter-rouge">data-toggle="collapse"</code> is required.
                    </p>
