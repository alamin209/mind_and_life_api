            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Alerts are available for any length of text, as well as an optional
                        ...
                        classes (e.g., <code class="highlighter-rouge">.alert-success</code>). For inline dismissal, use
                        the alerts jQuery plugin.</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Use the <code class="highlighter-rouge">.alert-link</code> utility class
                        to quickly provide matching colored links within any alert.</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        Add a dismiss button and the <code>.alert-dismissible</code> class, which adds extra padding to
                        the right of the alert and positions the <code>.close</code> button.
                    </p>
