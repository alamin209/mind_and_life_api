...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('title_li') Welcome to Mind & Life Dashboard   @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-xl-3">
            ...
            @endcomponent
            @component('common-components.dashboard-widget')
                @slot('title') total Artice  @endslot
                    ...
                    <div id="reviewExampleControls" class="carousel slide review-carousel" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <div>
                                    <p>For science, music, sport, etc, Europe uses the same vocabulary languages only
                                        differ in their grammar</p>
                                    <div class="media mt-4">
                                        <div class="avatar-sm mr-3">
                            ...
                            <a href="#">
                                <div class="media">
                                    <div class="mr-3 align-self-center">
                                        <img src="{{ URL::asset('public/images/users/avatar-3.png') }}" alt="" class="avatar-sm rounded-circle">
                                    </div>
