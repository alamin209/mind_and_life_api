                ...
                <div class="card-body">
                    <div class="profile-widgets py-3">
                        ...
                        <div class="text-center">
                            <div class="">
                                <img src="{{ URL::asset('public/images/users/avatar-2.png') }}" alt=""
                                    ...
                                    <div class="timeline-box col-lg-4">
                                        <div class="mb-5 mb-lg-0">
                                            ...
                                            <div class="bg-light p-4 rounded mx-3">
                                                ...
                                                <p class="text-muted mt-1 mb-0">Voluptatem accntium doemque lantium,
                                                    totam rem aperiam, eaque ipsa quae ab illo quasi sunt explicabo.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Timeline 1 -->
                                    ...
                                    <div class="timeline-box col-lg-4">
                                        <div class="mb-5 mb-lg-0">
                                            ...
                                            <div class="bg-light p-4 rounded mx-3">
                                                ...
                                                <p class="text-muted mt-1 mb-0">Vivamus ultrices massa tellus, sed
                                                    convallis urna interdum eu. Pellentesque htant morbi varius mollis
                                                    et quis nisi.</p>
                                    ...
                                    <div class="timeline-box col-lg-4">
                                        <div class="mb-5 mb-lg-0">
                                            ...
                                            <div class="bg-light p-4 rounded mx-3">
                                                ...
                                                <p class="text-muted mt-1 mb-0">Suspendisse potenti. senec netus
                                                    malesuada fames ac turpis egesta vitae blandit ac tempus nulla.</p>
