...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <h2 style="text-align: center">網站開發及設計報價</h2>
            <table width="100%" class="table-bordered" style="border:2px solid black !important">
                <tr style="border:2px solid black !important">
                    <td width="65%" style="border:2px solid black !important" class="textpadding">
                        <h4 style="font-weight:bold;padding: 4px;" class="textpadding">Company Name:安興榮電業有限公司 </h4>
                    </td>
                    <td style="border:2px solid black !important" width="35%">
                        <h4 style="font-weight:bold;padding: 4px;"> Date :31 August 2021 </h4>
                ...
                <tr style="border:2px solid black !important">
                    <td width="65%" style="border:2px solid black !important;padding: 4px;">
                        <h4 style="font-weight:bold;padding: 4px;"> Contact Person: 張健銘 </h4>
                    </td>
                ...
                <tr style="border:2px solid black !important">
                    <td width="65%" style="border:2px solid black !important">
                        <h4 style="font-weight:bold;padding: 4px;">Contact no : 2711 1482 </h4>
                    </td>
                    <td style="border:2px solid black !important" width="35%">
                        <h4 style="font-weight:bold ;padding: 4px; "> Quotation No. QTOHW31082020</h4>

                    </td>
                </tr>
                <tr style="border:2px solid black !important ;padding: 4px; ">
                    <td width="65%" style="border:2px solid black !important ; padding: 4px;">
                        <h4 style="font-weight:bold ;padding: 4px; ">Company Address: 九龍新蒲崗五芳街19-21號嘉榮工廠大廈4樓C室及11樓A，
                            B室 </h4>
                    </td>
                    <td style="border:2px solid black !important" width="35%">
            ...
            <h2 style="text-align: center;padding: 4px;"> 建立網上購物平台(月費形式)(12 個月) dynamic</h2>
            <table width="100%" class="table-bordered" style="border:2px solid black !important">
