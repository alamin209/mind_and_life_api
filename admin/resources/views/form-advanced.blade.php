        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">This plugin integrates by default with Twitter bootstrap using badges to
                        display the maximum lenght of the field where the user is inserting text. </p>
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted mb-2">
                            ...
                            If none is specified, the positioning will be defauted to 'bottom'.
                        </p>
